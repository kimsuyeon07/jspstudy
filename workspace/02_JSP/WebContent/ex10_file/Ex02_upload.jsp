...
<body>
	...
	<%
		...
		if (!dir.exists()) { // 해당 경로가 존재하지 않는다면, 실행한다.
		...
		MultipartRequest multipart = new MultipartRequest(
				...
				1024 * 1024 * 10, // 1024바이트 == 1KB, 1024KB == 1MB [ 1024 * 1024 * 10 : 10MB ]
				"UTF-8", // 인코딩
				new DefaultFileRenamePolicy()  // 기본 파일명 변경 정책 (동일한 파일을 업로드하면 원래 파일명에 숫자 추가)
				);
	%>
