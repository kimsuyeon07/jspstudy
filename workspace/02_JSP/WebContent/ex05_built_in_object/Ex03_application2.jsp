...
<%
	...
	// ↑ "\\." >> 이 부분에서 오류가 날 수도 있음. ip주소에서 '.' 이 없었음.
	/* ip.replaceAll("\\.", "_") : ip주소 안의 '.' =>> '_'로 수정해라 */
	...
	boolean isExist = file.exists(); // 파일이 정상적으로 생성되었다면 true를 반환
%>    
...
<script>
	...
	// history.back();
	location.href='/02_JSP/ex05/Ex03_application1.jsp';
</script>
